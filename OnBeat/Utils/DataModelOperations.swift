...
func addDeadline(to modelContext: ModelContext, name: String, dueDate: Date, prizeName: String, prizeImageData: Data?) {
    let newDeadline = Deadline(name: name, dueDate: dueDate, prizeName: prizeName, prizeImageData: prizeImageData)
    modelContext.insert(newDeadline)
}

func editDeadline(from modelContext: ModelContext, deadline: Deadline, newName: String, newDueDate: Date, newPrizeName: String, newPrizeImageData: Data?) {
